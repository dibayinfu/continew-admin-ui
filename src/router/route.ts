    ...
    children: [
      ...
      // ===== 临时工具（子菜单） =====
      {
        ...
        children: [
          ...
          { path: '/sanitation/track-analysis', name: 'SanitationTrackAnalysis', component: () => import('@/views/sanitation/track-analysis.vue'), meta: { title: '轨迹分析', icon: 'history', hidden: false } },
      ...
      // ===== 基础档案（子菜单） =====
      {
        ...
        children: [
          ...
          { path: '/sanitation/vehicle-weighing', name: 'SanitationVehicleWeighing', component: () => import('@/views/sanitation/vehicle-weighing.vue'), meta: { title: '整车称重设置', icon: 'file', hidden: false } },

...
export const driverTaskList: DriverTask[] = [
  {
    ...
    track: [
      { lng: 114.132, lat: 36.035, done: true, label: '西上庄村', time: '06:50' },
      { lng: 114.136, lat: 36.037, done: false, label: '接单' },
      { lng: 114.138, lat: 36.038, done: false, label: '装车点' },
      { lng: 114.142, lat: 36.041, done: false },
  ...
  },
  {
    ...
    track: [
      ...
      { lng: 114.136, lat: 36.067, done: false },
  ...
  },
  {
    ...
    steps: [
      ...
      { label: '到达始发地', done: true, time: '06:25' },
  ...
  },
  {
    ...
    steps: [
      ...
      { label: '到达始发地', done: true, time: '05:58' },
      { label: '装车', done: true, time: '06:00' },
      { label: '发车', done: true, time: '06:00' },
      { label: '到达目的地', done: true, time: '08:30' },
  ...
  },
  {
    ...
    steps: [
      ...
      { label: '到达始发地', done: true, time: '14:25' },
      { label: '装车', done: true, time: '14:30' },
      { label: '发车', done: true, time: '14:30' },
      { label: '到达目的地', done: true, time: '15:10' },
      { label: '卸车完成', done: true, time: '15:20' },
      { label: '上传照片', done: true, time: '15:22' },
    ],
    track: [

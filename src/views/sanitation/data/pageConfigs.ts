...
export const pageConfigs: Record<string, PrototypePageConfig> = {
  ...
  boxMap: makeConfig({
    key: 'boxMap',
    title: '箱体地图展示',
    subtitle: '在地图上展示小勾臂箱、大勾臂箱和中转站内箱体状态，异常箱体高亮。',
    phase: 'V1.0',
    priority: 'P0',
    module: '箱体监管',
    searchPlaceholder: '搜索箱体/位置',
    filters: ['全部', '正常', '预警', '满溢', '离线'],
    metrics: [{ label: '上图箱体', value: 269, unit: '个' }, { label: '满溢点', value: 11, unit: '个', tone: 'danger' }, { label: '离线点', value: 4, unit: '个', tone: 'warning' }],
    columns: [{ title: '箱体名称', dataIndex: 'name' }, { title: '箱体编号', dataIndex: 'boxNo' }, { title: '箱体类型', dataIndex: 'boxType' }, { title: '所属乡镇', dataIndex: 'town' }, { title: '所属中转站', dataIndex: 'station' }, { title: '满溢比例', dataIndex: 'fillRateText' }, { title: '状态', dataIndex: 'status' }],
    rows: boxRows,
    fieldOptions: { boxType: ['小勾臂箱', '大勾臂箱', '移动压缩箱'], status: ['正常', '预警', '满溢', '离线'] },
  }),
  ...
  taskOrderStats: makeConfig({
    key: 'taskOrderStats',
    title: '全部任务单',
    subtitle: '查看全部收运任务单，支持按状态筛选、详情查看和称重数据追溯。',
    phase: 'V1.5',
    priority: 'P0',
    module: '收运任务单',
    ...
    columns: [
      ...
      { title: '箱体名称', dataIndex: 'boxName', width: 180 },
      { title: '箱体类型', dataIndex: 'boxType', width: 100 },
      { title: '驾驶员', dataIndex: 'driver', width: 100 },
    ...
    prd: [
      {
        ...
        items: [
          ...
          { label: '数据来源', value: '任务单数据来自告警中心创建或收运单监控页快速创建，箱体位置从 boxes 档案匹配' },
          { label: '表格展示', value: '12 列字段：任务单号/名称/箱体/驾驶员/车辆/目的地/收运状态/超时状态/称重/创建时间/完成时间' },
          ...
          { label: '详情查看', value: '点击行操作栏「详情」图标，弹出侧边抽屉展示完整任务信息和收运轨迹 SVG 路线图' },
      ...
      },
      {
        ...
        items: [
          ...
          { label: '✓ 详情抽屉', value: '点击查看详情弹出侧边抽屉，含轨迹图和完整字段信息' },

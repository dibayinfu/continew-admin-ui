    ...
    children: [
      ...
      // ===== 基础档案（子菜单） =====
      {
        ...
        children: [
          ...
          { path: '/sanitation/vehicleArchive', name: 'SanitationVehicleArchive', component: () => import('@/views/sanitation/prototype.vue'), props: { pageKey: 'vehicleArchive' }, meta: { title: '车辆档案（删除）', icon: 'file', hidden: false } },
